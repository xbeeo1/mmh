...
class SaleSummaryReport(models.TransientModel):
    ...
    def action_print_sale_summary_report(self):
        ...
        return self.env.ref('xbo_mmh_report.action_pdf_sale_summary_report').report_action(self.id)
    ...
    def action_print_sale_summary_report_xlsx(self):
        ...
        return self.env.ref('xbo_mmh_report.action_xlsx_sale_summary_report').report_action(self.id)
