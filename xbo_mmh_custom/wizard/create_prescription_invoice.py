...
class create_prescription_invoice_inherit(models.TransientModel):
        ...
        for lab_req in lab_reqs:
            ...
            for p_line in lab_req.prescription_line_ids:
                ...
                invoice_line_vals = {
                    ...
                    'price_unit': lab_req.treatment_fees if p_line.medicament_id.product_id.is_checkup_fees and lab_req.treatment_fees else p_line.medicament_id.product_id.lst_price,
