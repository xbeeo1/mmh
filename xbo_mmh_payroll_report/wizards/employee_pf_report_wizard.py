...
class EmplyeePFWizard(models.TransientModel):
    ...
    def action_print_payslip(self):
        ...
        if pf_detail_obj:
            ...
            return self.env.ref('xbo_mmh_payroll_report.action_employee_pf_report').report_action(self, datas)
        else:
            raise ValidationError('No Record Found!')


class action_employee_pf_report(models.AbstractModel):
    _name = 'report.xbo_mmh_payroll_report.employee_pf_report_template'
